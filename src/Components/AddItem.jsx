                        ...
                        <div className='flex lg:flex-row flex-col gap-5 w-full'>
                            ...
                            <div className='w-full flex flex-col gap-3'>
                                ...
                                <div className="rating h-12 flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s bg-white rounded-lg px-3 border">
                                    ...
                                    <input type="radio" name="rating-2 rating" value="1" className="mask mask-star-2 bg-primary" checked {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="2" className="mask mask-star-2 bg-primary" {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="3" className="mask mask-star-2 bg-primary" {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="4" className="mask mask-star-2 bg-primary" {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="5" className="mask mask-star-2 bg-primary" {...register("rating")} />
                                </div>
