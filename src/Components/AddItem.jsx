...
export const AddItem = () => {
    ...
    return (
        <div>
            <div className="lg:w-full w-10/12 mx-auto lg:min-h-[calc(100vh-170px)] bg-cover bg-center bg-[url('https://i.ibb.co/XjPbcxh/gio-gix-1lk7g-F-p-Mx0-unsplash.jpg')] rounded-lg mb-5 flex flex-col items-center justify-center text-center mt-5  ">
                <Helmet>
                    <title>Fiber Fution | Add item</title>
                </Helmet>

                <div className='lg:w-11/12 md:w-8/12 w-full mx-auto flex flex-col items-center justify-center  text-black bg-[#252c2eab] p-5  rounded-xl space-y-2 font-medium md:my-5'>
                    <form onSubmit={handleSubmit(onSubmit)} className='mx-auto mt-10 flex flex-col gap-5 w-full'>
                        ...
                        <div className='flex gap-5 w-full'>
                            <div className='w-full flex flex-col gap-3'>
                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow	1s">
                                    ...
                                    <input className='text-black w-full' type="text" name='Img_url' placeholder="Image URL"
                                ...
                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s">
                                    ...
                                    <input className='text-black w-full' type="text" placeholder='Item Name' name='item_name' {...register("item_name", { required: true })} />
                                </label>
                                ...
                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s">
                                    ...
                                    <select name="sub_category" className='w-full h-full border-none bg-none outline-none' placeholder="Select" {...register("sub_category", { required: true })}>
                                ...
                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s">
                                    <svg xmlns="http://www.w3.org/2000/svg" className='w-5 h-5' viewBox="0 0 42 42" id="pen"><path fill="#231f20" d="M37.28 4.72a5.52 5.52 0 0 0-7.78 0L5.73 28.49a1.56 1.56 0 0 0-.42.84L4.3 36a1.5 1.5 0 0 0 1.48 1.73h.23l6.66-1a1.56 1.56 0 0 0 .84-.42L37.28 12.5a5.52 5.52 0 0 0 0-7.78ZM11.74 33.8l-4.17.63.63-4.17 19.52-19.51 3.53 3.53Zm23.42-23.42-2.49 2.49-3.54-3.54 2.49-2.49a2.5 2.5 0 1 1 3.54 3.54Z"></path></svg>
                                    <input className='text-black w-full' type="number" placeholder='Processing Time in Hour' name='processing_time' {...register("processing_time", { required: true })} />
                                </label>
                                {errors.processing_time && <span className='text-red-600 text-xs'>This field is required</span>}

                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s">
                                    <svg xmlns="http://www.w3.org/2000/svg" className='w-5 h-5' id="select"><path fill="none" d="M0 0h48v48H0z"></path><path d="M6 10h4V6c-2.21 0-4 1.79-4 4zm0 16h4v-4H6v4zm8 16h4v-4h-4v4zM6 18h4v-4H6v4zM26 6h-4v4h4V6zm12 0v4h4c0-2.21-1.79-4-4-4zM10 42v-4H6c0 2.21 1.79 4 4 4zm-4-8h4v-4H6v4zM18 6h-4v4h4V6zm4 36h4v-4h-4v4zm16-16h4v-4h-4v4zm0 16c2.21 0 4-1.79 4-4h-4v4zm0-24h4v-4h-4v4zm0 16h4v-4h-4v4zm-8 8h4v-4h-4v4zm0-32h4V6h-4v4zM14 34h20V14H14v20zm4-16h12v12H18V18z"></path></svg>
                                    <select name="stock_status" className='w-full h-full border-none bg-none outline-none' placeholder="Select" {...register("stock_status", { required: true })}>
                            ...
                            <div className='w-full flex flex-col gap-3'>
                                <label className="input input-bordered flex items-center gap-2">
                                    ...
                                    <input className='text-black w-full' type="number" name='price' placeholder="Price" {...register("price", { required: true })} />
                                </label>
                                {errors.price && <span className='text-red-600 text-xs'>This field is required</span>}

                                <div className="rating h-12 flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s bg-white rounded-lg px-3">
                                    ...
                                    <input type="radio" name="rating-2 rating" value="1" className="mask mask-star-2 bg-orange-400" checked {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="2" className="mask mask-star-2 bg-orange-400" {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="3" className="mask mask-star-2 bg-orange-400" {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="4" className="mask mask-star-2 bg-orange-400" {...register("rating")} />
                                    <input type="radio" name="rating-2 rating" value="5" className="mask mask-star-2 bg-orange-400" {...register("rating")} />
                                </div>
                                ...
                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s">
                                    ...
                                    <select name="customization" className='w-full h-full border-none bg-none outline-none' placeholder="Select" {...register("customization", { required: true })}>
                        ...
                        <button className='btn btn-outline text-white' type='submit'>Add Item</button>
                    </form>
